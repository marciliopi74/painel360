...
export const SUGESTOES_ERRO: Record<string, string> = {
  ...
  duplicado:
    "Existe mais de um cadastro para este cidadão (mesmo CNS, CPF ou DNV) — possivelmente em outra equipe/microárea, ex. após mudança de área; mantenha apenas o mais recente e desative os demais no e-SUS PEC.",
  duplicado_provavel:
    "Outro cadastro com o mesmo nome existe — possivelmente em outra equipe/microárea —, mas com CNS/CPF/DNV diferente. Comum quando o ACS cadastra a mesma pessoa duas vezes com documentos diferentes, ou quando ela muda de área e é recadastrada sem desativar o registro antigo. Confira no e-SUS PEC se é a mesma pessoa antes de desativar um dos registros; nomes iguais também podem ser pessoas distintas.",
